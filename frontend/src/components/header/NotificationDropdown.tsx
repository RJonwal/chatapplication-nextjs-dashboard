...
import { fetchNotificationThunk } from "@/store/slices/messageSlice";
...
export default function NotificationDropdown() {
  ...
  const { notifications } = useAppSelector((state) => state.messages);
    ...
    <>
      <div className="relative">
        ...
        >
          ...
          >
            <span className="absolute inline-flex w-full h-full bg-orange-400 rounded-full opacity-75 animate-ping">{notificationCount}</span>
          </span>
          <svg
        ...
        >
          <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
            ...
            <span
              className={` top-0.5 z-10 h-4 w-4 rounded-full bg-orange-400 flex items-center justify-center text-white text-xs font-bold ${notificationCount === 0 ? "hidden" : "flex"
                }`}
            >
