...
import { blockUser, checkAuth, fcmToken, login, logout, removeProfile, signup, socialLogin, updateProfile, viewProfile} from "../controllers/auth.controller.js";
...
router.post("/fcmtoken", protectRoute, fcmToken);
